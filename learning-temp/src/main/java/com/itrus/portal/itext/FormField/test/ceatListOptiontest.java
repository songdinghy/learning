 ...
 * @author qiumeng
 * @Package com.itrus.portal.itext.FormField.test
 * @Description: 这是添加选项列表
 * @date 2018 2018/1/4 14:31
 */
public class ceatListOptiontest {
    //源文件
    public static final String DEST =System.getProperty("user.dir")+"/pdf/FormField/123.pdf";
    //目标文件
    public static final String save =System.getProperty("user.dir")+"/pdf/FormField/listoption.pdf";
    ...
    public static void creatTextField(PdfStamper pdfStamper) throws IOException, DocumentException {
        ...
        PdfFormField form = PdfFormField.createList(writer,arr,1);
